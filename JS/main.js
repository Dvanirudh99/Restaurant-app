// Menu Items Array
const menuItems = [
    { item_name: "French Fries", price: 50.00, cuisineType: "Snacks" },
    { item_name: "Fried Rice", price: 150.00, cuisineType: "Chinese" },
    { item_name: "Noodles", price: 250.00, cuisineType: "Chinese" },
    { item_name: "Pasta", price: 150.00, cuisineType: "Italian" },
    { item_name: "Coffee", price: 150.00, cuisineType: "Drinks" },
    { item_name: "Soft drinks", price: 150.00, cuisineType: "Drinks" },
    { item_name: " Soups", price: 150.00, cuisineType: "Soup" },
    { item_name: "Ice Cream", price: 80.00, cuisineType: "Desserts" },
    {item_name: "Onion Rings", price: 150.00, cuisineType: "Snacks" },
    {item_name: "Salad", price: 250.00, cuisineType: "Desserts" },
];
...
const makeMenuCard = (itemName, price, cuisineType) => {
    var menuCard =
        ...
        <p class = "card-cuisine">Course Type:${cuisineType}</p>
    </section>`;
    return menuCard;
}
        ...
        `<div class="modal">
            <div class = 'modal-content'>
                ...
                <div class="modal-footer">
                    ...
                    <p class = "footer-btn" onclick = "endSession(this);">Close Session(Generate Bill)</p>
                </div>
            </div>
        </div>`;
...
function makeItemsHtml(dishMap) {
    let itemHtml =
        `<div class='details-header'>
            <p style=" font-weight: bold">S.NO</p>
            <p style=" font-weight: bold">Item</p>
            <p class='price-column' style=" font-weight: bold">Price</p>
        </div>`;
    let i = 1;
...
function dragDrop(e) {
    ...
    //change this for quantity and itmes segregation
